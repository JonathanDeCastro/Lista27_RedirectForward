...
public class CalculadoraRestController {
    ...
    public RedirectView somarQuery(@RequestParam(value = "n1", defaultValue = "0") Double n1,
			...
			atributos.addAttribute("operacao","soma");
			atributos.addAttribute("usuario","admin");
    ...
    public Double somarPath(@PathVariable("numero1") String numero1,
							...
							@ModelAttribute("usuario") String user,
							@ModelAttribute("operacao") String operacao,
							Model model) {
	System.out.println("Usuário: " + model.getAttribute("usuario"));
    ...
    public ModelAndView calcularPotenciaQuery(@RequestParam(value = "base", defaultValue = "0") String base,
    						 	        ...
    						 	        ModelMap modelo) {
			modelo.addAttribute("operacao","potencia");
			modelo.addAttribute("usuario","operador");
			
			return new ModelAndView("redirect:/calcular-potencia-path/" + base + "/" + expoente, modelo);
    }
    ...
    public Double calcularPotenciaPath(@PathVariable String base,
    					    		   ...
    					    		   @ModelAttribute("operacao") String oper,
    					    		   @ModelAttribute("usuario") String user,
    					    		   Model modelo) {
    	System.out.println("Usuário: " + modelo.getAttribute("usuario"));
    	System.out.println("Operação: " + modelo.getAttribute("operacao"));
    ...
    public ModelAndView calcularRaizQuery(@RequestParam(value = "numero", defaultValue = "0") String numero,
    									  HttpServletRequest requisicao){
    	requisicao.setAttribute("operacao", "raiz");
    ...
    public String calcularRaizPath(@PathVariable String numero,
    							   HttpServletRequest requisicao) {
    	System.out.println("Operação: " + requisicao.getAttribute("operacao"));
