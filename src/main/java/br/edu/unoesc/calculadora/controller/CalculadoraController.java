...
// -----------------------------------------------------------------------------------------------------------------
    ...
    public String subtraiQuery(@RequestParam(value = "n1", defaultValue = "0") String n1,
		...
		atributos.addFlashAttribute("v2", n2);
    ...
    //----------------
    @GetMapping("/subtrai-forward-query")
    public String subtraiForwardQuery(@RequestParam(value = "n1", defaultValue = "0") String n1,
    						       @RequestParam(value = "n2", defaultValue = "0") String n2,
    						       ModelMap model,
    						       HttpServletRequest requisicao) {	
		model.addAttribute("v1", n1);
    	requisicao.setAttribute("v2", n2);
		
    	return "forward:/subtrai-forward-path/" + n1 + "/" + n2;
    }
    
    @GetMapping("/subtrai-forward-path/{numero1}/{numero2}")
    public String subtraiForwardPath(@PathVariable String numero1, 
    							  @PathVariable String numero2,
    							  Model model,
    							  HttpServletRequest requisicao) {
    	System.out.println(requisicao.getAttribute("v1") + " - " + requisicao.getAttribute("v2"));
 ...
 // -----------------------------------------------------------------------------------------------------------------
     ...
     public String multiplicaQuery(@RequestParam(value = "n1", defaultValue = "0") String n1,
     	...
     	return "redirect:/multiplica-path/" + n1 + "/" + n2;
     }
